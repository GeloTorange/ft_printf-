...
/*   Updated: 2020/01/13 18:20:25 by rmaple           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static intmax_t	get_num(t_Options *tab)
{
	intmax_t	num;
...
static char		get_negatvity_placeholder(t_Options *tab, int is_negative)
{
	char	*tmp;
...
static t_Options	*do_d(t_Options *tab, intmax_t num, int num_width, int align_left)
{
	int			not_blank;
