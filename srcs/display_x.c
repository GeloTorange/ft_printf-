...
/*   Updated: 2020/01/13 18:46:25 by rmaple           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static uintmax_t	get_num(t_Options *tab)
{
	uintmax_t	num;
...
static t_Options		*do_x(t_Options *tab, uintmax_t num, char *str, int align_left)
{
	int			n_b;
	int			n_w;
